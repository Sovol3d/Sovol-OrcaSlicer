    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(0, 142, 172), StateColor::Pressed);
    border_color.append(wxColour(38, 171, 203), StateColor::Hovered);
    // border_color.append(0x009688, StateColor::Normal);
    border_color.append(0x009bb9, StateColor::Normal);
    ...
    background_color.append(wxColour(0, 142, 172), StateColor::Pressed);
    background_color.append(wxColour(38, 171, 203), StateColor::Hovered);
    // background_color.append(0x009688, StateColor::Normal);
    background_color.append(0x009bb9, StateColor::Normal);
