...
{
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#006c8c"))); // ORCA use orca color for radio buttons
    } else {
        ...
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#009bb9"))); // ORCA use orca color for radio buttons
    }
}
