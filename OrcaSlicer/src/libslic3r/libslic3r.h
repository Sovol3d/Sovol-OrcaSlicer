...
#define SLIC3R_APP_FULL_NAME "Sovol Slicer"
#define GCODEVIEWER_APP_NAME "SovolSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "SovolSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("SovolSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
