    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("SovolSlicer_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Sovol Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Sovol Slicer is based on OrcaSlicer, Orca Slicer is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "SovolSlicer_about_dark" : "SovolSlicer_about", FromDIP(125));
...
// #endif
    ...
    text_list.push_back(_L("SovolSlicer is based on OrcaSlicer, OrcaSlicer is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://github.com/Sovol3d/Sovol-OrcaSlicer\">https://github.com/Sovol3d/Sovol-OrcaSlicer </ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
