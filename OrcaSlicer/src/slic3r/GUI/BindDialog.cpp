...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
    ...
    //  m_link_Terms_title->SetForegroundColour(wxColour(0x009688));
     m_link_Terms_title->SetForegroundColour(wxColour(0x009bb9));
    ...
    //  m_link_privacy_title->SetForegroundColour(wxColour(0x009688));
     m_link_privacy_title->SetForegroundColour(wxColour(0x009bb9));
    ...
    //  m_link_notice_title->SetForegroundColour(wxColour(0x009688));
     m_link_notice_title->SetForegroundColour(wxColour(0x009bb9));
...
std::string icon_path = (boost::format("%1%/images/SovolSlicerTitle.ico") % resources_dir()).str();
     ...
     StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(38, 171, 203), StateColor::Hovered),
                             std::pair<wxColour, int>(wxColour(0, 155, 185), StateColor::Normal));
     m_button_unbind->SetBackgroundColor(btn_bg_green);
     m_button_unbind->SetBorderColor(wxColour(0, 155, 185));
