...
wxBoxSizer* FileArchiveDialog::create_btn_sizer()
{
    ...
    auto apply_highlighted_btn_colors = [](Button* btn) {
        btn->SetBackgroundColor(StateColor(std::pair<wxColour, int>(wxColour(0, 142, 172), StateColor::Pressed),
                                           std::pair<wxColour, int>(wxColour(38, 171, 203), StateColor::Hovered),
                                           std::pair<wxColour, int>(wxColour(0, 155, 185), StateColor::Normal)));

        btn->SetBorderColor(StateColor(std::pair<wxColour, int>(wxColour(0, 155, 185), StateColor::Normal)));
